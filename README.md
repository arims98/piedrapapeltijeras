...
Multi-idioma: Soporte completo para Castellano, Catalán e Inglés.

Historial de Partidas: Registro local de resultados usando base de datos SQLite.

Buscador integrado: Filtra tus partidas históricas fácilmente desde la barra de navegación.
...
Persistencia: SQLite (DBHelper)

Audio: MediaPlayer con Service y AudioFocus

UI: Android XML Layouts, Material Design

Extras: SoundPool (para efectos de sonido rápidos)
